...
class Settings(BaseSettings):
    ...
    edge_calibration_refresh_after_scan_limit: int = 200
    ...
    edge_calibration_late_label_backfill_enabled: bool = True
    edge_calibration_late_label_max_age_seconds: int = 7 * 86400
    edge_calibration_late_label_min_age_seconds: int = 86400
    edge_calibration_late_label_sample_weight: float = 0.5
    edge_calibration_include_observed_statuses_during_bootstrap: bool = True
    edge_calibration_observe_only_sample_weight: float = 0.5
    edge_calibration_risk_rejected_sample_weight: float = 0.25
    edge_calibration_bootstrap_sample_threshold: int = 600
    edge_calibration_use_optimistic_heuristic_floor: bool = False
    edge_calibration_min_confidence_for_calibrated_edge: float = 0.5
    edge_calibration_negative_ic_edge_multiplier: float = 0.5
    edge_calibration_bad_ic_edge_multiplier: float = 0.7
    edge_calibration_defensive_fallback_ic_threshold: float = -0.05
